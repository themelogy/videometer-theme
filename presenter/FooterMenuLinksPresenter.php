<?php namespace Modules\Theme\Presenters\Videometer;
...
class FooterMenuLinksPresenter extends Presenter
{
    ...
    {
        return PHP_EOL.'<ul class="list list--primary">'.PHP_EOL;
    }
    ...
    {
        return '<li'.$this->getActiveState($item).'>'.$item->getIcon(). '<a href="'.$item->getUrl().'" '.$item->getAttributes().'>'.$item->title.'</a></li>'.PHP_EOL;
    }
