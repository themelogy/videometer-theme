<?php
namespace Modules\Theme\Presenters\Videometer;
...
class HeaderMenuPresenter extends Presenter
{
    ...
    {
        return PHP_EOL.'<ul class="primary-menu-menu">'.PHP_EOL;
    }
     ...
     * {@inheritdoc }.
     */
    public function getActiveState($item, $state = ' class="hover-ver2 active"')
    {
        return $item->isActive() ? $state : ' class="hover-ver2"';
    }
     ...
     * @return null|string
     */
    public function getActiveStateOnChild($item, $state = ' hover-ver2 active')
    {
        return $item->hasActiveOnChild() ? $state : ' class="hover-ver2"';
    }
