        ...
        <div class="row">
            ...
            <div class="info">
                <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
                    <div class="heading">
                        <h3 class="heading-title">
                            <img src="{{ Theme::url('img/logo-white.png') }}" alt="{{ setting('theme::company-name') }}"/>
                        </h3>
                        ...
                        <p class="heading-text">
                            @if($page = Page::find(2))
                                {!! strip_tags(str_sentence($page->body, 3)) !!}
                            @endif
                        </p>
                    </div>
                    ...
                    <div class="socials">
                        ...
                        @foreach($socials as $social)
                            @if($link = setting('theme::'.$social))
                                <a href="{{ $link }}" class="social__item" target="_blank">
                ...
                <div class="col-lg-4 col-lg-offset-1 col-md-4 col-md-offset-1 col-sm-12 col-xs-12">
                    ...
                    <div class="services">
                        <div class="heading">
                            <h3 class="heading-title">{{ $menu->title }}</h3>
                            <div class="heading-line">
                                <span class="short-line"></span>
                                <span class="long-line"></span>
                            </div>
                        </div>
                        {!! Menu::render($menu->name, \Modules\Theme\Presenters\Videometer\FooterMenuLinksPresenter::class) !!}
                    </div>
                </div>
                @endif
            </div>
        ...
        <div class="row">
            <div class="contacts">
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="contacts-item">
                        <div class="icon js-animate-icon">
                            <svg enable-background="new 0 0 64 64" version="1.1" viewBox="0 0 64 64" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"><polyline fill="none" points="  54,17 32,36 10,17 " stroke="#f15b26" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="2"/>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <span>
                        ...
                        {!! trans("themes::theme.footer.titles.copyrights",[
                        'url'=>'http://www.qbicom.com.tr',
                        'powered'=>'Qbicom Digital',
