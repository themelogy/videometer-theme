                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide client-item">
                            <a href="09_our_clients.html" class="client-image">
                                <img src="{{ Theme::url("img/client1-hover.png") }}" alt="logo" class="hover">
                            </a>
                        </div>

                        <div class="swiper-slide client-item">
                            <a href="09_our_clients.html" class="client-image">
                                <img src="{{ Theme::url("img/client2-hover.png") }}" alt="logo" class="hover">
                            </a>
                        </div>

                        <div class="swiper-slide client-item">
                            <a href="09_our_clients.html" class="client-image">
                                <img src="{{ Theme::url("img/client3-hover.png") }}" alt="logo" class="hover">
                            </a>
                        </div>

                        <div class="swiper-slide client-item">
                            <a href="09_our_clients.html" class="client-image">
                                <img src="{{ Theme::url("img/client4-hover.png") }}" alt="logo" class="hover">
                            </a>
                        </div>
